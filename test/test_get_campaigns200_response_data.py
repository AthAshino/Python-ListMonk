...
class TestGetCampaigns200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCampaigns200ResponseData:
        """Test GetCampaigns200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCampaigns200ResponseData`
        """
        model = GetCampaigns200ResponseData()
        if include_optional:
            return GetCampaigns200ResponseData(
                results = [
    ...
    def testGetCampaigns200ResponseData(self):
        """Test GetCampaigns200ResponseData"""
